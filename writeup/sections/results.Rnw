...
o2<-rbind(o2,data.frame(max.pop=out$max.pop,value=out$q1,type="q1"))
o2<-rbind(o2,data.frame(max.pop=out$max.pop,value=out$q2,type="q2"))
q1 <- ggplot(o2,aes(x=max.pop,y=value,colour=type))+geom_point()
